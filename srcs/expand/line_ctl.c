...
/*   Updated: 2023/12/09 13:50:18 by jeongbpa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_line	*subline(t_line *line, int start, int end)
{
	...
	i = 0;
	sub = (t_line *)malloc(sizeof(t_line));
	sub->data = (char *)malloc(sizeof(char) * (end - start + 1));
	sub->info = (char *)malloc(sizeof(char) * (end - start + 1));
	while (start < end)
	{
...
int	ft_delete_line(int len, t_line *line, int start)
{
	...
	i = -1;
	if (len == 0 || ft_strlen(line->data) < len || ft_strlen(line->info) < len)
		return (0);
